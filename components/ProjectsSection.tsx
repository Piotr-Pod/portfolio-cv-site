      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div className="mb-16" variants={itemVariants}>
            <div className="bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-border">
          ...
          >
            {projects.slice(1).map((project, index) => (
              <motion.div
                key={index}
                className="bg-card rounded-2xl p-8 shadow-md hover:shadow-lg transition-all duration-300 group border border-border"
                whileHover={{ y: -5 }}
              >
                ...
                <div className="flex gap-3">
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-border text-muted-foreground hover:border-cyan-500 hover:text-cyan-500"
                  >
