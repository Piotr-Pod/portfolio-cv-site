...
export default async function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "connect-src 'self' https://vercel.live https://va.vercel-scripts.com https://www.clarity.ms https://clarity.ms https://scripts.clarity.ms" + (process.env.NEXT_PUBLIC_UMAMI_SCRIPT_URL ? ` ${new URL(process.env.NEXT_PUBLIC_UMAMI_SCRIPT_URL).origin}` : ''),
